...
ALTER TABLE ai_conversations ADD COLUMN IF NOT EXISTS ai_profile_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE ai_conversations DROP COLUMN IF EXISTS ai_profile_id;
